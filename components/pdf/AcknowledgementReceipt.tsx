      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <Text style={styles.headerTitle}>Tenant360</Text>
            <Text style={styles.headerSub}>Tenant360 — Maintenance Acknowledgement Receipt</Text>
          </View>
        ...
        <View style={styles.footer} fixed>
          <Text style={styles.footerText}>
            This is a tamper-evident document generated by Tenant360. Any alteration renders
            it invalid. Reference: {ref} · © {new Date().getFullYear()} Tenant360
          </Text>
        </View>
      </Page>
    </Document>
